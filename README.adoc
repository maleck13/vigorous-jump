...
IMPORTANT: This runs best when deployed to OpenShift in order to use the circuit breaker functionality. For more details on using this booster with a single-node OpenShift cluster, CI/CD deployments, as well as the rest of the runtime, see the link:http://launcher.fabric8.io/docs/thorntail-runtime.html[WildFly Swarm Runtime Guide].
...
----
$ git clone git@github.com:maleck13/vigorous-jump
...
== More Information
You can learn more about this booster and rest of the WildFly Swarm runtime in the link:http://launcher.fabric8.io/docs/thorntail-runtime.html[WildFly Swarm Runtime Guide].
